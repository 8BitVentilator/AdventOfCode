...
Add-Content $SourceFile ("{")
Add-Content $SourceFile ("    protected override object Result_Example_PartOne => 0;")
Add-Content $SourceFile ("    protected override object Result_Example_PartTwo => 0;")
Add-Content $SourceFile ("    protected override object Result_PartOne => 0;")
Add-Content $SourceFile ("    protected override object Result_PartTwo => 0;")
Add-Content $SourceFile ("")
