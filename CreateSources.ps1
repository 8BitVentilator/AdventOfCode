...
Add-Content $SourceFile ("{")
Add-Content $SourceFile ("    public PuzzleResult Result { get; } = new(")
Add-Content $SourceFile ("        ExamplePartOne: 0,")
Add-Content $SourceFile ("        ExamplePartTwo: 0,")
Add-Content $SourceFile ("        PartOne: 0,")
Add-Content $SourceFile ("        PartTwo: 0")
Add-Content $SourceFile ("    );")
Add-Content $SourceFile ("")
